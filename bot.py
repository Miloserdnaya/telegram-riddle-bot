...
async def update_weekly_ratings():
    """Обновить рейтинг каждую неделю в понедельник"""
    try:
...
async def post_init(app: Application):
    ...
    logger.info("Обновление рейтинга: каждый понедельник в 00:00")
    logger.info("Выдача грантов: каждое воскресенье в 00:00 (топ-10 лидеров, которые еще не получали)")
